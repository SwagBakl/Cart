...
<center>
    <div class="edit-form col-7 shadow-lg">
        ...
        <form action="/ht/characts/${htChars.homeTheater.id}/save" method="post">
            ...
            <input type="hidden" name="id" value="${htChars.id}">
            <input type="hidden" name="tab_id" value="${htChars.homeTheater.id}">
