...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/tab/addTab" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить планшет
...
<div class="mt-1 ">
    <form method="get" action="/tab/tabList" class="d-flex search ">
     ...
     <#list tabList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/tab/${list.id}" class="btn btn-warning form-control">
                    <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/tab/delete/${list.id}" class="btn btn-warning form-control">
                 ...
                 <a href="/tab/${list.id}/characts" class="btn btn-warning form-control">
