...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/notebook/addNB" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить ноутбук
    ...
    <div class="mt-1 ">
        <form method="get" action="/notebook/nBList" class="d-flex search ">
     ...
     <#list nbList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/nb/${list.id}" class="btn btn-warning form-control">
                     <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/nb/delete/${list.id}" class="btn btn-warning form-control">
                 ...
                 <a href="/notebook/${list.id}/characts" class="btn btn-warning form-control">
