...
<center>
    <div class="edit-form col-7 shadow-lg">
        <h3 class="display">Редактор характеристик телевизора</h3>
        <form action="/tv/characts/${tvChars.tv.id}/save" method="post">
            ...
            <input type="hidden" name="id" value="${tvChars.id}">
            <input type="hidden" name="tab_id" value="${tvChars.tv.id}">
