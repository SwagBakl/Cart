...
<center>
    <div class="edit-form col-7 shadow-lg">
        <h3 class="display">Редактор характеристик музыкального центра</h3>
        <form action="/mc/characts/${mcChars.musicCenter.id}/save" method="post">
            ...
            <input type="hidden" name="id" value="${mcChars.id}">
            <input type="hidden" name="tab_id" value="${mcChars.musicCenter.id}">
