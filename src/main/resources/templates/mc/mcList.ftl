...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/mc/addMc" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить музыкальный центр
    ...
    <div class="mt-1 ">
        <form method="get" action="/mc/mcList" class="d-flex search ">
     ...
     <#list mcList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/mc/${list.id}" class="btn btn-warning form-control">
                    <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/mc/delete/${list.id}" class="btn btn-warning form-control">
                 ...
                 <a href="/mc/${list.id}/characts" class="btn btn-warning form-control">
