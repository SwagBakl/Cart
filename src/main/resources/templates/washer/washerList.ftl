...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/washer/addWasher" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить стиральную машину
    ...
    <div class="mt-1 ">
        <form method="get" action="/washer/washerList" class="d-flex search ">
     ...
     <#list washerList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/washer/${list.id}" class="btn btn-warning form-control">
                    <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/washer/delete/${list.id}" class="btn btn-warning form-control ">
                 ...
                 <a href="/washer/${list.id}/characts" class="btn btn-warning form-control">
