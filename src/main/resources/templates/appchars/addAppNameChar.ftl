...
<div class="col-sm-8 add-section">
    <div>
        <div>
            ...
            <form method="post" action="/appchars/appCharNameList" enctype="multipart/form-data" class="col-12" id="add_form">
        ...
        <button type="submit" class="btn btn-warning shadow-lg">Добавить
        </button>
        </form>
    </div>
</div>
