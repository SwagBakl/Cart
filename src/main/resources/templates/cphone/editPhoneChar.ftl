...
<center>
    <div class="edit-form col-7 shadow-lg">
        <h3 class="display">Редактор характеристик телефона</h3>
        <form action="/cphone/characts/${cpChars.cellPhone.id}/save" method="post">
            ...
            <input type="hidden" name="id" value="${cpChars.id}">
            <input type="hidden" name="tab_id" value="${cpChars.cellPhone.id}">
