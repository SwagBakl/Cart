...
<h3 class="display orange">Характеристики электроники</h3>
    <#if isAdmin>
<a class="btn btn-warning shadow-lg d-inline-flex" href="/appchars/addAppValueChar">
...
<div class="div_center">
    <form method="get" action="/appchars/appCharValueList" class="form-inline">
...
<div class="card-col-sum mb-4 shadow-lg col-8">
    <table class="table">
        ...
        <#list appCharValue as elect>
        <tbody>
        <tr>
            <td><b>${elect.charValue}</b></td>
            <td><a href="/appcharsValue/${elect.id}" class="btn btn-warning shadow-lg d-inline-flex">Редактировать
                <i class="material-icons ml-2">
                    edit
                </i>
            </a></td>
            <td><a href="/appCharsValue/delete/${elect.id}" class="btn btn-warning shadow-lg d-inline-flex">Удалить
                <i class="material-icons ml-2 ">
                    delete_forever
                </i>
            </a></td>
