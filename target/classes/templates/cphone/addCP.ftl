...
<center>
    <div class="col-sm-8 add-section shadow-lg mt-5">
        <div>
            <h3 class="display ">Добавление телефона</h3>
            <div>
                <form method="post" action="/cphone/phoneList" enctype="multipart/form-data" class="col-12" id="add_form">
        ...
        Выберите файл <input type="file" name="file" id="file" onchange="return fileValidation()">
                    ...
                    <button type="submit" class="btn btn-warning shadow-lg mr-1">Добавить</button>
