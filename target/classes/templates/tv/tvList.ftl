...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/tv/addTv" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить телевизор
    ...
    <div class="mt-1 ">
        <form method="get" action="/tv/tvList" class="d-flex search ">
     ...
     <#list tvList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/tv/${list.id}" class="btn btn-warning form-control">
                    <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/tv/delete/${list.id}" class="btn btn-warning form-control">
                 ...
                 <a href="/tv/${list.id}/characts" class="btn btn-warning form-control">
