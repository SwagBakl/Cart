...
<center>
    <div class="col-sm-8 add-section shadow-lg mt-5">
        <div>
            <h3 class="display ">Добавление телевизора</h3>
            <div>
                <form method="post" action="/tv/tvList" enctype="multipart/form-data" class="col-12" id="add_form">
        ...
        Выберите файл <input type="file" name="file" id="file" onchange="return fileValidation()">
                    ...
                    <div class="d-inline-flex">
                        ...
                        <a class="btn btn-warning shadow-lg ml-1 d-inline-flex" href="/tv/tvList">Отмена
                            <i class="material-icons ml-1">
                                cancel
                            </i>
                        </a>
