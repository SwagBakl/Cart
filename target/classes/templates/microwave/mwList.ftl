...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/microwave/addMw" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить микроволновую печь
    ...
    <div class="mt-1 ">
        <form method="get" action="/microwave/mwList" class="d-flex search ">
     ...
     <#list mwList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/microwave/${list.id}" class="btn btn-warning form-control">
                     <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/microwave/delete/${list.id}" class="btn btn-warning form-control">
                 ...
                 <a href="/microwave/${list.id}/characts" class="btn btn-warning form-control">
