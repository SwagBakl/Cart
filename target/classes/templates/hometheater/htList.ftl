...
<div class="d-flex justify-content-between">
    <#if isAdmin>
<div class="mt-2 ">
    <a href="/hometheater/addHT" class="btn btn-warning add_button d-inline-flex shadow-lg" >Добавить домашний кинотеатр
    ...
    <div class="mt-1 ">
        <form method="get" action="/hometheater/htList" class="d-flex search ">
     ...
     <#list htList.content as list>
         <div class="card  mr-4 shadow-lg border border-warning rounded">
             ...
             <div class="card-footer text-muted">
                <#if isAdmin>
                <a href="/hometheater/${list.id}" class="btn btn-warning form-control">
                    <span class="d-inline-flex">Редактировать
                    <i class="material-icons ml-2">
                        edit
                    </i></span>
                </a>
                <a href="/hometheater/delete/${list.id}" class="btn btn-warning form-control">
                 ...
                 <a href="/ht/${list.id}/characts" class="btn btn-warning form-control">
